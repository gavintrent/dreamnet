  ...
  return (
    <div className="px-4 sm:px-8 md:px-16 lg:px-24 mt-4">
        ...
        <div className="relative-inline-block">
            ...
            <div className="absolute -top-6 left-full ml-2 flex flex-col items-center space-y-[-0.2rem] pointer-events-none select-none z-10">
              <span className="animate-z1 text-xs text-white">Z</span>
              <span className="animate-z2 text-sm text-white">Z</span>
              <span className="animate-z3 text-base text-white">Z</span>
            </div>
        </div>
