...
export default function NotebookPage({ htmlContent, currentPage, totalPages, setCurrentPage, title, username, timestamp }) {
  return (
    <div className="absolute inset-0 bg-[var(--cream-color)] border border-gray-400 rounded-xl shadow-md overflow-hidden">
      {/* Lined Background */}
      ...
      {/* Content */}
      <div className={`relative z-10 px-[8%] leading-[30px] text-black whitespace-pre-wrap font-['Jersey_10'] ${
        currentPage === 0 ? 'pt-[0px]' : 'pt-[8px]'
      }`}>
